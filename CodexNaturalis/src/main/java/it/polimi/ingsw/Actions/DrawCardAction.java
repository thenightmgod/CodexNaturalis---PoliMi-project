...
public class DrawCardAction extends Actions {
    ...
    public void executor() throws WrongIndexException, RemoteException, RoomNotExistsException, RequirementsNotSatisfied, NameAlreadyTakenException, InvalidOperationException, WrongPositionException, WrongPlayersNumberException, RoomFullException {
